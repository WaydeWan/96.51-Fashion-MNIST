"""
Fashion-MNIST ViT Training Script

Uses timm's vit_tiny_patch16_224 model, expands 28×28 grayscale images to three channels and scales to 224×224.
"""
...
def get_loaders(batch_size: int = 128, image_size: int = 224) -> Tuple[DataLoader, DataLoader]:
...
def main():
    ...
    for epoch in range(max_epochs):
        ...
        if improved:
            wait = 0
            no_improve_count = 0
            model_path = script_dir / "vit_fmnist.pt"
