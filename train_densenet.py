"""
Fashion-MNIST DenseNet Training Script

Based on torchvision's DenseNet-121, adapted for 28×28 grayscale input.
"""
...
def build_model(num_classes: int = 10) -> nn.Module:
    ...
    # Modify first convolution layer to adapt to single channel and small size
